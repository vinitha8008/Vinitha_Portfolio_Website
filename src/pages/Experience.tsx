...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      type: "Previous Role",
      responsibilities: [
        "Developed and optimized Power BI reports and dashboards for business intelligence",
        "Implemented data models and performed complex data analysis",
        "Collaborated with stakeholders to gather requirements and deliver analytical solutions",
        "Maintained and enhanced existing BI systems for improved performance"
      ]
    },
    {
      ...
      type: "Previous Role",
      responsibilities: [
        "Worked on automotive component engineering projects",
        "Analyzed technical specifications and requirements",
        "Collaborated with engineering teams on product development",
        "Ensured quality standards and compliance in engineering processes"
      ]
    },
    {
      title: "Internship",
      ...
      type: "Internship",
      responsibilities: [
        "Gained hands-on experience in automotive industry processes",
        "Supported various engineering and analytical projects",
        "Learned industry best practices and methodologies",
        "Contributed to team projects and technical documentation"
      ]
    }
  ];
