  ...
  return <div className="min-h-screen bg-background">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6">
          {educationData.map((edu, index) => <Card key={index} className="p-6 shadow-soft hover:shadow-medium transition-smooth">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-data-secondary rounded-full flex items-center justify-center">
                    {edu.type === "Higher Education" ? <GraduationCap className="w-6 h-6 text-primary" /> : <Award className="w-6 h-6 text-primary" />}
                  </div>
                </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="font-medium text-foreground text-xs">Score:</span>
                      <span className="bg-primary text-primary-foreground px-2 py-1 rounded font-semibold text-xl">
                        {edu.percentage}
                      </span>
                    </div>
                  </div>
